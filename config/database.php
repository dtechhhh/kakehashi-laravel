...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // CLI migrate / RefreshDatabase only. No fallback to DB_USERNAME/DB_PASSWORD.
        // Supply DB_MIGRATOR_* via process env or .env.migrator — never PHP-FPM/queue runtime .env.
        'pgsql_migrator' => [
            'driver' => 'pgsql',
            ...
            'username' => env('DB_MIGRATOR_USERNAME'),
