@props(['label' => null, 'name' => null, 'id' => null, 'type' => 'text', 'value' => null, 'error' => null, 'hint' => null])
...
<div {{ $attributes->only(['class']) }}>
    ...
    <input @if ($inputId) id="{{ $inputId }}" @endif @if ($name) name="{{ $name }}" @endif type="{{ $type }}" value="{{ $value }}"
